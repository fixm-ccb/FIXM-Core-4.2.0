...
This edition of the FIXM User Manual provides guidance for [FIXM Core 4.2.0](https://fixm.aero/release.html?rel=FIXM-4.2.0&ret=core), the [FF-ICE Application 1.0.0](https://fixm.aero/release.html?rel=FFICE-Msg-1.0.0&ret=app) and the [Basic Application 1.0.0](https://fixm.aero/release.html?rel=Basic-Msg-1.0.0&ret=app).
...
[FIXM Core 4.2.0]: https://fixm.aero/release.html?rel=FIXM-4.2.0&ret=core
[FF-ICE Application]: https://fixm.aero/release.html?rel=FFICE-Msg-1.0.0&ret=app
[Basic Application]: https://fixm.aero/release.html?rel=Basic-Msg-1.0.0&ret=app
